...
export const FOCUS_REGEN_COOLDOWN = 3;
...
export const RED_KILL_QUOTA = 20;
export const BLUE_KILL_QUOTA = 30;

export const RED_POTION_DURATION = 720;
export const BLUE_POTION_DURATION = 300;
...
export function multiplyBulletDamage() {
  BULLET_CONFIGS.rifle.damage = 36;
  BULLET_CONFIGS.orb.damage = 112.5;
  BULLET_CONFIGS.rocket.damage = 210;
}

export function resetBulletDamage() {
  BULLET_CONFIGS.rifle.damage = 24;
  BULLET_CONFIGS.orb.damage = 75;
  BULLET_CONFIGS.rocket.damage = 140;
}

export const DASH_DISTANCE = 260;
export const DASH_STEP = 14;
